...
function loadcard(c, hide) {
    ...
    var str = "<table id='" + c._id + "' class='card-holder " + attr + hidden + "' card='" + JSON.stringify(c) + "'>"
        + "<tr>"
        + "<td class='name-holder' colspan='3'>"
        + "<p>" + c.card.name + "</p>"
        + "</td>"
        + "<td class='value-holder cost'>" + c.card.temp_cost + "</td>"
        + "</tr>"
        + "<tr>"
        + "<td class='image-holder' colspan='4'>"
        + "<img src='/images/" + c.card.avatar + "'>"
        + "</td>"
        + "</tr>"
        + "<tr>"
        + "<td class='effect-holder' colspan='4'>" + c.card.effect.name + "</td>"
        + "</tr>"
        + "<tr>"
        + "<td class='value-holder atk'>" + c.card.temp_attack + "</td>"
        + "<td class='value-holder rarity' colspan='2'>" + c.card.grade + "</td>"
        + "<td class='value-holder hp'>" + c.card.temp_health + "</td>"
        + "</tr>"
        + "</table>";
    return str;
}
